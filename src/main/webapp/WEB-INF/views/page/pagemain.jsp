...
<title>${owner.username }'s Page</title>
</head>
<body class="pageLayout">
	...
	<div id="pageContainer">
		<div id="left_menu">
			<img alt=""
				src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUR8v_RKhOj8THJ69eowTVphsn-b_YsQJJ8I9yIqqV56nfhPvujA">
			<br> <a href="${path}/pagemain/${member.userid}" id="text_pagehome">page</a> <br>
			<ul id="left_menu_ul">
				<li><a>홈</a></li>
				<li><a>게시물</a></li>
				<li><a>리뷰</a></li>
...
$(function(){
	$("#pagetext").append("<p id='pagetext'>"+'${member.username }'+" </p>");
});
</script>