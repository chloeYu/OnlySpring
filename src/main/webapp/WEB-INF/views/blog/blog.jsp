						...
						<form action="/only/postWrite" method="post"
							...
							<div class="bloc" style="display: none;">
 							...
 							<div class="write_type_choice">
								...
								<a class="choice_type"> <br><img alt="" src="${path }/img_timeline/picture.svg"
								...
								<a class="choice_type"><img alt="" src="${path }/img_timeline/location.svg"
									class="img_hide img_hidden type_photo" width="30px" border='0'
									id="google">
									<input type="button" name="google" style='display: none;' 
									id="google" onclick="google()">
									</a>
								<a class="choice_type" id="friendTagBtn"><img alt="" src="${path }/img_timeline/friendTag.png	"
