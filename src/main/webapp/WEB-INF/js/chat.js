$(document).ready(function() {
	...
	var root = url + appCtx;
					...
					function appendMessage(msg) { // msg를 messages-content에 추가
						...
						$('<div class="message loading new"><figure class="avatar"><img src="/OnlySpring//WEB-INF/img_all/user.png" /></figure><span></span></div>')
								.appendTo($('.mCSB_container'));
						updateScrollbar();
						setTimeout(
								function() {
									$('.message.loading').remove();
									$('<div class="message new"><figure class="avatar"><img src="/OnlySpring//WEB-INF/img_all/user.png" /></figure>'
													+ msg + '</div>')
											.appendTo($('.mCSB_container'))
											.addClass('new');
									setDate();
